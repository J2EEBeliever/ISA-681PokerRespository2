...
public class DeleteMe_AES {
	 ...
	 * @throws DeleteMe_AES.InvalidKeyLengthException
	 *   if keyLength is not 128, 192, or 256
	 * @throws DeleteMe_AES.StrongEncryptionNotAvailableException
	 ...
	 * @throws DeleteMe_AES.InvalidPasswordException
	 *   if the given password was not used to encrypt the data
	 * @throws DeleteMe_AES.InvalidAESStreamException
